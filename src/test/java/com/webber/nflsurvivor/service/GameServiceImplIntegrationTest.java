...
public class GameServiceImplIntegrationTest {
    ...
    public void testCreateGame() {
        ...
        Integer week = 1;
        OffsetDateTime gameStartTime = OffsetDateTime.now();
    ...
    public void testFindGamesForWeek() {
        ...
        Game game1 = new Game(homeTeam1, awayTeam1, 1, OffsetDateTime.now());
        Game game2 = new Game(homeTeam2, awayTeam2, 1, OffsetDateTime.now());
        Game game3 = new Game(homeTeam3, awayTeam3, 2, OffsetDateTime.now());
